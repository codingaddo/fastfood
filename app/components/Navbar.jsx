    ...
    return(
        ...
        <div className={ isScroll? " z-50 fixed w-full bg-white shadow-2xl flex justify-between items-center md:px-14 p-4 md:py-4 py-5":'fixed z-50  w-full bg-white flex justify-between items-center md:px-14 p-4 md:py-4 py-5'}>
            ...
            <ul className="hidden md:flex justify-between items-center gap-10 font-medium">
                <li className="hover:text-red-600 uppercase"><Link className={pathName==='/' ?"text-[#fa6969]" :''} href={'/'}>Home</Link></li>
                <li className="hover:text-red-600 uppercase"><Link className={pathName==='/about' ?"text-[#fa6969]" :''} href={'/about'}>About</Link></li>
                <li className="hover:text-red-600 uppercase"><Link className={pathName==='/menu' ?"text-[#fa6969]" :''} href={'/menu'}>Menu</Link></li>
                <li className="hover:text-red-600 uppercase"><Link className={pathName==='/catering' ?"text-[#fa6969]" :''} href={'/catering'}>Catering</Link></li>
                <li className="hover:text-red-600 uppercase"><Link className={pathName==='/contact' ?"text-[#fa6969]" :''} href={'/contact'}>Contact</Link></li>
            </ul>
        ...
        <div className={isOpen?" open-nav  z-50 p-10 md:hidden":"Rnav  z-50 p-10 md:hidden"} onClick={()=>{setIsOpen(false)}}>
            ...
            <li className="hover:text-red-600 uppercase"><Link  href={'/'} className={pathName==='/' ?"text-[#fa6969]" :''} onClick={()=>{setIsOpen(false)}}>Home</Link></li>
                ...
                <li className="hover:text-red-600 uppercase"><Link className={pathName==='/contact' ?"text-[#fa6969]" :''} href={'/contact'} onClick={()=>{setIsOpen(false)}}>Contact</Link></li>
            </ul> 
        </div>
    </>
